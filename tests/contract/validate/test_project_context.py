"""context/project-context/v1 fixture validation (w1-11)."""
...
SCHEMA_PATH = (
    CONTRACTS_JSON_SCHEMA_DIR / "context" / "project-context" / "v1" / "project-context.schema.json"
)
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "project-context"
