"""context/workspace-context/v1 fixture validation (w1-11)."""
...
SCHEMA_PATH = (
    ...
    / "workspace-context"
    / "v1"
    / "workspace-context.schema.json"
)
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "workspace-context"
