"""domain/extracted-claim/v1 fixture validation (w4-10 Contracts Steward)."""
...
SCHEMA_PATH = (
    CONTRACTS_JSON_SCHEMA_DIR / "domain" / "extracted-claim" / "v1" / "extracted-claim.schema.json"
)
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "extracted-claim"
