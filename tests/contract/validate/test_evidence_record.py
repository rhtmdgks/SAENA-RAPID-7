"""domain/evidence-record/v1 fixture validation (w4-10 Contracts Steward)."""
...
SCHEMA_PATH = (
    CONTRACTS_JSON_SCHEMA_DIR / "domain" / "evidence-record" / "v1" / "evidence-record.schema.json"
)
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "evidence-record"
